...
- (void) setDialogBackgroundColor: (UIColor*) color {
    [_dialog setBackgroundColor: color];
}

- (void) setTextColor: (UIColor*) color highlighted:(UIColor*) highlightedColor {
    [_dialogLabel setTextColor: highlightedColor];
    [_button1 setTitleColor:color forState: UIControlStateNormal];
    [_button2 setTitleColor:color forState: UIControlStateNormal];
    [_button1 setTitleColor:highlightedColor forState: UIControlStateHighlighted];
    [_button2 setTitleColor:highlightedColor forState: UIControlStateHighlighted];
    [_activityIndicator setColor: highlightedColor];
}
